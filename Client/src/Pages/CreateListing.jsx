...
import { RemoveCircleOutline, AddCircleOutline, Preview } from '@mui/icons-material'
      ...
      <div className='create-listing'>
        ...
        <form action="" onSubmit={handlePost}>
          <div className='create-listing_step1'>
            ...
            <hr />
            <h3>which of these categroies , best describes your place </h3>
            ...
            <h3> What type of place will the guests require? </h3>
                ...
                <div className='basic_count'>
                  <RemoveCircleOutline
                    ...
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
                      "&:hover": { color: excludeVariablesFromRoot.pinkred }
                    }} />
                  <p>{guestCount}</p>
                  <AddCircleOutline
          ...
          <div className='create-listing_step2'>
            ...
            <hr />
            <h3>Tell your guests what your place has to offer</h3>
                            ...
                            <Draggable key={index} draggableId={index.toString()} index={index} >
                              {(provided) => (
                                <div className='photo' ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                                  ...
                                  <button type='button' onClick={() => handleRemovePhoto(indexx)}>
                                    <BiTrash />
